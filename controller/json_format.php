        ...
        if (is_array($val)) {
            ...
            foreach ($val as $k => $v) {
                ...
                if (is_array($v)) {
                    ...
                    $template['phase_name'][$pCount]["group_name"][$gCount]['group_quantity'] = count($v);
                    ...
                    foreach ($v as $_k => $_v){
                        ...
                        if(!empty($iName[$Pname[$pCount]][$gName[$Pname[$pCount]][$gCount]][$iCount])){
                            if($iName[$Pname[$pCount]][$gName[$Pname[$pCount]][$gCount]][$iCount] == "NULL"){
                                continue;
                            }else{
