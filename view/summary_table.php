<table class="tbl_tc  except" style="max-width: 2058px; margin: auto;">
    ...
    <tbody id="TClines">
        <tr>
            <th class="noBorder head" colspan=80 style="color : rgba(0, 182, 255,1)">Terms and Conditions</th>
        </tr>
    ...
    <tbody id="AClines">
        <tr>
            <th class="noBorder head" colspan=80 style="color : rgba(0, 182, 255,1)">ESDS's Assumptions and Considerations</th>
        </tr>
        <tr>
    ...
    <tbody id="EXlines">
        <tr>
            <th class="noBorder head" colspan=80 style="color : rgba(0, 182, 255,1)">ESDS's Exclusions</th>
        </tr>
        <tr>
