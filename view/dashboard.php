        ...
        <div class="except container-fluid">
            ...
            <div class="except row">
                <div class="except col-lg-3 col-6">
                    <!-- small box -->
                    <div class="except small-box bg-info">
                ...
                <div class="except col-lg-3 col-6">
                    <!-- small box -->
                    <div class="except small-box bg-success">
                        <div class="except inner">
                            <?php
                ...
                <div class="except col-lg-3 col-6">
                    <!-- small box -->
                    <div class="except small-box bg-secondary">
                        <div class="except inner">
                ...
                <div class="except col-lg-3 col-6">
                    <!-- small box -->
                    <div class="except small-box bg-danger">
                        <div class="except inner">
                            <h3><?= (gettype($iUsers) == "array") ? count($iUsers) : 0; ?></h3>
